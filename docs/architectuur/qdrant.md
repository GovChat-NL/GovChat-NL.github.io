...
![Embedding proces](../img/diagrams/qdrant-embedding.png)
...
![Document ingestie](../img/diagrams/qdrant-ingest.png)
...
![RAG proces](../img/diagrams/qdrant-rag.png)
...
Qdrant draait als container binnen de GovChat-NL stack. De volledige service-configuratie staat in [`docker-compose.yml`](https://github.com/GovChat-NL/GovChat-NL/blob/main/docker-compose.yml) in de GovChat-NL repository.
