...
![LiteLLM routing](../img/diagrams/litellm-routing.png)
...
![LiteLLM load balancing](../img/diagrams/litellm-loadbalance.png)
...
LiteLLM draait als container binnen de GovChat-NL stack. De volledige service-configuratie staat in [`docker-compose.yml`](https://github.com/GovChat-NL/GovChat-NL/blob/main/docker-compose.yml) in de GovChat-NL repository.
